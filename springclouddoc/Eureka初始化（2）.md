...
> 完整包路径： com.netflix.discovery.EurekaClientConfig。用来配置eureka-client向Eureka-server注册的信息。
...
> 包路径：com.netflix.discovery.DefaultEurekaClientConfig，它是基于配置文件Eureka-Client配置的EurekaClientConfig的默认实现，
